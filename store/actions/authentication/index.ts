...
import { ErrorObjectType, PersonalityProfileType, StateRoot, UserType, UserProfileType, OrganisationProfileType, ReducerAction, Dispatch } from '@make.org/types';
import {
...
export const loginRequest = (): ReducerAction => ({ type: actionTypes.LOGIN_REQUEST });
