...
export const i18n = {
  ...
  getResourceBundle: (lng: string, ns: string): any => instance.getResourceBundle(lng, ns),
  getResource: (lng: string, ns: string, key: string, options?: InitOptions): any => instance.getResource(lng, ns, key, options),
};
