...
export const PROPOSAL_MODIFY_PENDING = 'PROPOSAL_MODIFY_PENDING';
export const PROPOSAL_CLEAR_PENDING = 'PROPOSAL_CLEAR_PENDING';
export const PROPOSAL_SET_STEP = 'PROPOSAL_SET_STEP';
export const PROPOSAL_RESET_STEP = 'PROPOSAL_RESET_STEP';
/** Panel action */
